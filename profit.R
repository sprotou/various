...
profit = function(x) {
	...
	profit = (x[1]-c)*sales - x[2]						# profit = revenues-cost. Revenues = price*units sold. Cost = ad dollars spent
	return(profit)
}
...
### Most importantly, only numerical or only analytical maximization may not work. But,together, they can and often do. 
